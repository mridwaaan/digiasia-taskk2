    ...
    <div class="row">
        ...
        <section class="col-lg-12 ">
          ...
          <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
              <a class="btn btn-info" href="<?php echo base_url();?>site/add_site"><i class="fa fa-plus"></i>&nbsp;New Site</a><br><br>
              <table id="dtables" class="dtable table-bordered table-striped">
                ...
                <?php foreach ($site as $s): ?>
                    <tr>
                      <td style="padding-left: 18px"><?php echo $s->site_name; ?></td>
                      <td style="padding-left: 18px"><a class="btn btn-round btn-info btn-xs" href="<?php echo base_url();?>site/edit_site/<?php echo $s->site_id; ?>"><i class="fa fa-pencil"></i></a>
