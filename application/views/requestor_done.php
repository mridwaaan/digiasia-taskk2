    ...
    <div class="row">
        ...
        <section class="col-lg-12 ">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <!-- FILTER FORM -->
              <form action="<?php echo base_url(). 'requestor/request_filter'; ?>" method="post">
                <div class="col-lg-1">
                  Date<br><br><br>
                  Type
                </div>
                ...
                <div class="col-lg-12">
                  <center>
                    <input type="submit" name="Search" value="Search" class="btn btn-round btn-primary">
                  </center>
                  <br><br>
                </div>
              </form>
                    ...
                    <?php foreach ($request as $r): ?>
                      <?php $no=$no+1; ?>
                        <tr>
                          ...
                          <td style="padding-left: 18px"><?php echo $r->type_name; ?></td>
                          <td style="padding-left: 18px"><?php echo $r->site_name; ?></td>
                          <td style="padding-left: 18px"><?php echo $r->requested_by_name; ?></td>
                          <td style="padding-left: 18px"><?php echo $r->closed_by; ?></td>
                          <td style="padding-left: 18px"><?php if($r->request_attachment!=""){ ?><a class="btn btn-round btn-warning btn-xs" href="<?php echo base_url('assets/images/request/'.$r->request_attachment) ?>" target="_blank"><i class="fa fa-arrow-down"></i></a><?php } ?></td> 
                          <!--
                          <td style="padding-left: 18px"><?php if($r->form_file!=""){ ?><a class="btn btn-round btn-success btn-xs" href="<?php echo base_url('assets/images/form/'.$r->form_file) ?>" target="_blank"><i class="fa fa-arrow-down"></i></a><?php } ?></td>
                          -->
                          <td style="padding-left: 18px">
                            <a class="btn btn-round btn-info btn-xs" href="<?php echo base_url();?>requestor/print_form_request/<?php echo $r->request_id; ?>"><i class="fa fa-print"></i>Print</a>
                            <!--
                            <a class="btn btn-round btn-info btn-xs" href="#check_id_<?php echo $r->request_id?>" data-toggle="modal">Check Response</a>
                            <a class="btn btn-round btn-primary btn-xs" href="<?php echo base_url();?>requestor/resend/<?php echo $r->request_id; ?>">Resend Response</a>
                            -->
                          </td>
                        </tr>
                    <?php endforeach; ?>
