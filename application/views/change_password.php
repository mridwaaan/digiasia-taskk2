    ...
    <div class="row">
        ...
        <section class="col-lg-12 ">
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <form action="<?php echo base_url(). 'auth/change_password_process'; ?>" method="post">
            <input type="text" name="admin_id" value="<?php echo $this->session->userdata('admin_id'); ?>" hidden>
            <?php foreach ($id as $i): ?>
